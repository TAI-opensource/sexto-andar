              ...
              <div className="bg-white p-6 border border-gray-200 rounded-lg sticky top-20">
                <div className="text-center mb-6">
                  <div className="text-3xl font-bold text-primary mb-1">
                    {formatPrice(property.valor_venda1 || (property.precos && property.precos.length > 0 ? property.precos[0].valor : "Consulte"))}
                  </div>
                ...
                {property.id.startsWith("user_") && (
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 text-sm text-[#1b4332] hover:text-[#143526] font-medium"
                    >
                      ...
                      {property.instagram_url ? "Ver publicação no Instagram" : "Ver no Instagram"}
                    </a>
                    <p className="text-xs text-gray-400 mt-2 text-center">
                      Mais informações, fotos e vídeos no Instagram
                    </p>
                  </div>
                )}
              </div>
                    ...
                    >
                      ...
                      <div className="p-4">
                        <div className="text-lg font-bold text-primary mb-1">
                          {formatPrice(item.valor_venda1 || (item.precos && item.precos.length > 0 ? item.precos[0].valor : "Consulte"))}
                        </div>
